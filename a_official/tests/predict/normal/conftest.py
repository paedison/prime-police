...
@pytest.fixture
def official_test_user(db, official_test_user_info):
    return factories.UserFactory(**official_test_user_info)


@pytest.fixture
def logged_client(official_test_user) -> Client:
    client = Client()
    client.force_login(official_test_user)
    return client


@pytest.fixture
def official_test_student(
        official_test_user: User,
        official_test_exam: models.Exam,
        official_test_student_info: dict,
):
    return factories.PredictStudentFactory(
        user=official_test_user,
        exam=official_test_exam,
        **official_test_student_info
    )
...
def predict_fixture(
    ...
    return dict(
        ...
        student_info=official_test_student_info,
    )
