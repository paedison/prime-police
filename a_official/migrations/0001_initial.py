    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(choices=a_official.models.choices.year_choice, default=2025, verbose_name='연도')),
                ('exam', models.CharField(choices=a_official.models.choices.exam_choice, default='경위', max_length=2, verbose_name='시험')),
                ('subject', models.CharField(choices=a_official.models.choices.subject_choice, default='형사', max_length=2, verbose_name='과목')),
                ('number', models.IntegerField(choices=a_official.models.choices.number_choice, default=1, verbose_name='문제 번호')),
                ('answer', models.IntegerField(choices=a_official.models.choices.answer_choice, default=1, verbose_name='정답')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating', models.IntegerField(choices=a_official.models.choices.rating_choice, default=1)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('remarks', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.IntegerField(choices=a_official.models.choices.answer_choice, default=1)),
