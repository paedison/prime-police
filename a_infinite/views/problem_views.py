...
class ProblemConfiguration:
    ...
    url_admin = reverse_lazy(f'admin:a_infinite_problem_changelist')
    url_list = reverse_lazy(f'infinite:problem-list')
    url_create_collection = reverse_lazy('infinite:collection-create')
