...
def problem_list_view(request: utils.HtmxHttpRequest, models, filters, config):
    menu = config.menu
...
def like_problem(request: utils.HtmxHttpRequest, pk: int, models):
...
def rate_problem(request: utils.HtmxHttpRequest, pk: int, models):
    problem = get_object_or_404(models.Problem, pk=pk)
...
def memo_problem(request: utils.HtmxHttpRequest, pk: int, models, forms):
    view_type = request.headers.get('View-Type', '')
    problem = get_object_or_404(models.Problem, pk=pk)
...
def tag_problem(request: utils.HtmxHttpRequest, pk: int, models):
    view_type = request.headers.get('View-Type', '')
    problem = get_object_or_404(models.Problem, pk=pk)
...
def collection_list_view(request: utils.HtmxHttpRequest, models, config):
    collections = []
...
def collection_create(request: utils.HtmxHttpRequest, models, forms):
    view_type = request.headers.get('View-Type', '')
...
def collection_detail_view(request: utils.HtmxHttpRequest, pk: int, models, forms):
    view_type = request.headers.get('View-Type', '')
...
def collect_problem(request: utils.HtmxHttpRequest, pk: int, models):
    if request.method == 'POST':
